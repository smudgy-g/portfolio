const projects = [
  {
    "description": "xhibit is a social media platform inspired by Instagram. Users can sign up, sign in, create, like, edit, save, and delete posts, as well as maintain their profiles. The app features a feed, and users can search for posts.",
    "name": "exhibit",
    "projectUrl": "https://github.com/smudgy-g/exhibit",
  ...
  },
{
  ...
  {
    "description": "An AI-powered personal journal that itegrates Ai and Large Language Models to track the users mood through analysis of each journal entry with mapping to a chart. Users can query for insights into their journal history.",
    "name": "journai",
    "projectUrl": "https://github.com/smudgy-g/journai",
